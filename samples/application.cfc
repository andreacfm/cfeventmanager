<cfcomponent output="false">
	...
	<cffunction name="onApplicationStart" returnType="boolean" output="false">
		...
		<cfset application.EventManager.loadXml('/EventManager/samples/config/helloWorldExample.xml')/>		
				
		<cfset application.EventManager.loadXml('/EventManager/samples/config/dataCollectionExample.xml')/>
		
		<cfset application.EventManager.loadXml('/EventManager/samples/config/interceptionExample.xml')/>
