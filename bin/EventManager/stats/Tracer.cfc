...
Version:     1.0.2
Build Date:  mercoledì gen 06, 2010
Build:		 119
...
<cfcomponent output="false">
	...
	<!---init--->
	<cffunction name="init" output="false" returntype="EventManager.stats.Tracer">
	...
	<cffunction name="trace" returntype="void" output="false" access="public">
		...
		<cfargument name="event" required="false" type="EventManager.events.Event"/>
