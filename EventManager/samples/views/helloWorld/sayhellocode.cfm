...
<pre>
	...
	&lt;cfset application.EventManager.loadXml('/EventManager/samples/config/helloWorldExample.xml')/><br/>	
...
&lt;event-manager><br/>
    ...
    &lt;listeners><br/>
        ...
        &lt;listener 
            ...
            listener="EventManager.samples.handlers.helloWorld"
        /><br/>
...
<p>Xml add the event 'beforeWelcomeOutput' that use the standard event class and a listener with class 'EventManager.samples.handlers.helloWorld' that is registered 
to observe event 'beforeWelcomeOuput'.</p>
<p>At this point we know that anytime event 'beforeWelcomeOuput' is dispatched the method 'beforeWelcomeOutput' of listener 'EventManager.samples.handlers.helloWorld' is invoked.</p>
...
&lt;cfcomponent><br/>
	...
	&lt;cffunction name="beforeWelcomeOutput" access="public" output="false">    
		&lt;cfargument name="event" type="eventmanager.events.Event" /><br/>
