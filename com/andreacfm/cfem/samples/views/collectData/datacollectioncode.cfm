...
<pre>
	...
	&lt;cfset application.com.andreacfm.cfem.loadXml('/EventManager/samples/config/dataCollectionExample.xml')/><br/>	
...
&lt;event-manager><br/>
    ...
    &lt;events><br/>
        ...
        &lt;event name="getPods" type="com.andreacfm.cfem.events.CollectDataEvent" /><br/>
    ...
    &lt;listeners><br/>
        ...
        &lt;listener 
            event="getPods" 
            listener="com.andreacfm.cfem.samples.handlers.getpods" />
        /><br/>

        &lt;listener 
            event="getPods" 
            listener="com.andreacfm.cfem.samples.handlers.getpods2"
            priority="10"
        />
...
<p>We use an event of class com.andreacfm.cfem.events.CollectDataEvent that is designed to internally store an array of 'items' and expose methods
   to add and getItems. We have 2 listeners that will listen to event 'getPods'</p>

<h3>getpods.cfm</h3>
<pre>

&lt;cfset ev = application.com.andreacfm.cfem.createEvent('getPods')/><br/>
&lt;cfset application.com.andreacfm.cfem.dispatchEvent(event=ev) /><br/>
...
.......<br/>
	...
	&lt;cffunction name="getPods" access="public" returntype="void" output="false">     
		&lt;cfargument name="event" type="com.andreacfm.cfem.events.AbstractEvent" /><br/>
