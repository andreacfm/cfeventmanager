...
<pre>
	...
	&lt;cfset application.com.andreacfm.cfem.loadXml('/EventManager/samples/config/interceptionExample.xml')/><br/>	
...
<pre>
    &lt;events><br/>	
        ...
        &lt;event name="getLinks" type="com.andreacfm.cfem.events.CollectDataEvent"><br/>	
        ...
        &lt;event name="addDefaultLink" type="com.andreacfm.cfem.events.CollectDataEvent"/><br/>	
    ...
    &lt;listeners><br/>	
        ...
        &lt;listener 
            event="getLinks" 
            listener="com.andreacfm.cfem.samples.handlers.linksHandler" /><br/>	
...
<pre>
&lt;cfset ev = application.com.andreacfm.cfem.createEvent('getLinks')/><br/>
&lt;cftry><br/>
